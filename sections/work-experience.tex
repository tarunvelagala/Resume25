...
\begin{onecolentry}
    \begin{highlights}
        ...
        \item Led the migration of query tools and code usages with Python scripts and AWS services during the Redshift private subnet migration which holds \textbf{2.6 PB} data, maintaining \textbf{100\%} data availability across \textbf{4} services.
...
\begin{twocolentry}{
    ...
    \textit{Bengaluru, KA}}
    \textbf{Technical Support Engineer II}
